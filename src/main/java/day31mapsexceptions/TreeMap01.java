...
public class TreeMap01 {
    public static void main(String[] args) {
        ...
        System.out.println(countryPopTree); //{Belgium=12000000, Brasil=215000000, Finland=8000000, France=75000000, Germany=85000000, Mexico=125000000, Netherland=18000000, Turkiye=83000000, USA=400000000}

        long t3 = System.nanoTime();
        System.out.println(t2-t1); //HashMap=3599500
        System.out.println(t3-t2); //TreeMap=401400
    }
}
