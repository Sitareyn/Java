...
public class Student {
    ...
    Data nasil saklanir??  ==> Tabii ki access modifier ini private yaparak diger class larda görünmez hale
    getirir görünmez hale getiririrz. Boylece datayi saklariz
