...
/*
NOT1=Switch Condition parantezi icinde "String , int , byte , short , char ; kullanilabilir
NOT2=Switch Condition parantezi icinde "Long , Booluen , Float , Double kullanilmaz
 */
