...
/*            3 ==> 3x1=3
    ...
    //Örnek2) Verilen bir String de her harfin sonrasina "*" sembolu ekleyiniz
        // J*a*v*a
    ...
    //Örnek3) Bir stringdeki tekrarsiz karakterkeri konsola yazdiriniz
        // kertenkelle ==> rtn
        //indexOf(k)==> 0           farkli,tekrarli
        //lastindexOf ==> 6

        //indexOf("r")==>2
        //lastindexOf("r")==>2    ayni ise tekrsrsiz
